        ...
        <div class="content-body p-6 bg-neutral-50 rounded-2xl relative">
            <form action="{{ $updateLocation }}" method="POST">
                ...
                <div class="form-header mb-5">
                    <h2 class="text-2xl">Edit Data Asli</h2>
                </div>
                <div class="form-body mb-6">
                    <div class="field-text flex flex-col gap-4 mb-5">
                        <x-input-form key="created_at" placeholder="Masukkan kode alternatif" type="date" title="Tanggal"
                            value="{{ date_format($dataAsli->created_at, 'Y-m-d') }}" disabled=true />
                    </div>

                    <div class="select-field">
                        <div class="form-group flex flex-col gap-3">
                            <label for="alternatif_id" class="text-neutral-950 font-medium">Alternatif</label>
                            <div class="" x-data="{ id: {{ $dataAsli->alternatif_id }} }"
                                x-effect="$(`select#alternatif_id`).val(id).change()">
                        ...
                        <div class="form-group flex flex-col gap-3">
                            ...
                            <div class="" x-data="{ id: '{{ $dataAsli->status }}' }" x-effect="$(`select#status`).val(id).change()">
