        ...
        <div class="header mb-6">
            <div class="wrap flex justify-between">
                ...
                <div class="action">
                    <div class="sort-action relative" x-data="{
                    ...
                    }" x-effect="console.log(sortby)">
                        <button class="button items-center flex gap-2 bg-neutral-50 p-3 rounded-xl"
                        ...
                        <div x-show="isSortOpen"
                            class="absolute z-10 bg-neutral-50 shadow-lg w-80 right-0 top-14 px-6 py-4 rounded-lg">
            ...
            <div class="table w-full">
                <div class="header-table flex justify-between items-center mb-6">
                    <div class="header-title">
                        <h1 class="text-2xl font-semibold">Masukkan Data Kriteria</h1>
                    </div>
