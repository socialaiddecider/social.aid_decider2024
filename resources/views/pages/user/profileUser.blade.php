                    ...
                    <div class="image-profile w-full min-h-64 rounded-2xl relative flex justify-end items-stretch"
                        ...
                        <div class="grid grid-rows-2 items-start">
                            ...
                            <form action="{{ $updateBackgroundLocation }}" method="POST" class="self-end">
                                ...
                                <button type="submit"
                                    class="backdrop-blur-sm backdrop-brightness-50 m-4 px-4 py-2 rounded-md">
                        ...
                        <div class="avatar-image absolute -bottom-14 left-9 inline-flex gap-2 items-end">
                            <div class="avatar image w-24 h-24 rounded-md relative"
                                ...
                                <form action="{{ $updateAvatarLocation }}" method="POST" enctype='multipart/form-data'
                                    ...
                                    @csrf
                                    <label for="image">
                                        <input type="file" class="hidden" name="image_avatar" id="image"
                                            accept="image/*" @change.prevent="$refs.avatarForm.submit()" />
                                        <div
                                ...
                                <div class="grid grid-flow-row gap-4">
                                    ...
                                    <div class="grid grid-flow-row gap-2">
                                        <x-input-form key="nik" type="text" placeholder="nik" title="NIK"
                                            :value="$user->nik" />
                                        <x-input-form key="name" type="text" placeholder="nama lengkap"
                                            title="Nama Lengkap" :value="$user->name" />
                                ...
                                <div class="grid grid-flow-row gap-4">
                                    ...
                                    <div class="grid grid-flow-row gap-2">
                                        <x-input-form key="new_password" type="password" placeholder="password"
                                            title="Password Baru" />
                                        <x-input-form key="new_password_confirmation" type="password"
                                            placeholder="password" title="Konfirmasi Password Baru" />
                                    </div>
                                </div>
                                <div class="form-action flex my-4 justify-end">
                                    <button type="submit"
