    ...
    <main class="profile overflow-scroll h-screen no-scrollbar">
        ...
        <section class="mx-2 sm:mx-10 md:mx-20 -mt-8">
            <div class="flex justify-center mt-20">
                <div class="card-verify bg-neutral-50 rounded-xl relative w-full lg:w-1/2">
                    <div
                    ...
                    <div class="card-body px-2 md:px-10 py-8">
                        <div class="card-verify-header mb-4 text-center">
                            <h1 class="text-2xl md:text-4xl font-bold">Verify Your Email!</h1>
                        </div>
                        <div class="card-verify-body flex flex-col items-center">
                            <div class="card-text px-2 leading-5 sm:w-2/4 text-center">
                                <p class="text-xs sm:text-sm">A verification link has been sent to your email address.
                                    Please click on
                                    the
                                    link
                            ...
                            <form action="{{ $verifyEmailLocation }}" method="post">
                                @csrf
                                <button type="submit"
                                    class="btn bg-primary-500 text-neutral-50 px-6 text-sm sm:text-base font-semibold py-2 rounded-xl  mt-4">Resend
                                    Verification
                                    Link</button>
                            </form>
